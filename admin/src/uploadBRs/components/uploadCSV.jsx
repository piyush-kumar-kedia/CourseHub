      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-800">BRs Email Uploading Portal</h1>
          </div>
          <p className="text-gray-600 text-lg">Upload CSV file to extract and validate email addresses</p>
        </div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
            ...
            {fileName && (
              <div className="mt-4 p-3 bg-gray-100 rounded-lg">
                <p className="text-sm text-gray-600">Selected: <span className="font-medium">{fileName}</span></p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-gray-50 rounded-lg p-4 text-center">
                <div className="text-3xl font-bold text-gray-800">{emails.length}</div>
                <div className="text-gray-600">Total Emails Found</div>
              </div>
              <div className="bg-green-50 rounded-lg p-4 text-center">
                <div className="text-3xl font-bold text-green-600">{validEmails.length}</div>
                <div className="text-gray-600">Valid Emails</div>
              </div>
              <div className="bg-red-50 rounded-lg p-4 text-center">
                <div className="text-3xl font-bold text-red-600">{invalidEmails.length}</div>
